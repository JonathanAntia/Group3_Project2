...
def scores (dictionaryOfUserInput):
    ...
    neighborhood_group_with_counts=neighborhood_group_with_counts.loc[(neighborhood_group_with_counts['Valuation Index']>0)&(neighborhood_group_with_counts['Sales Index']>0),:]

    min=neighborhood_group_with_counts['Valuation Index'].min()
    max=neighborhood_group_with_counts['Valuation Index'].max()
    min=neighborhood_group_with_counts['Valuation Index']=(neighborhood_group_with_counts['Valuation Index']-min)/(max-min)*100
